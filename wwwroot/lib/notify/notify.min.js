    ...
    return (function () {
            ...
            (this.status = a),
                ...
                this.checkRequirements()
                    ? (this.setContainer(),
                      this.setWrapper(),
                      this.setPosition(),
                      this.isIcon && this.setIcon(),
                      this.isCloseButton && this.setCloseButton(),
                      this.setContent(),
        ...
        return (
            ...
            (o.prototype.setContainer = function () {
                ...
                t ? (this.container = t) : ((this.container = document.createElement("div")), this.container.classList.add("notifications-container"), document.body.appendChild(this.container)),
                    this.container.style.setProperty("--distance", this.distance + "px");
            }),
            (o.prototype.setPosition = function () {
                var t = "notify-is-";
                this.position.includes("left") ? this.container.classList.add(t + "left") : this.container.classList.remove(t + "left"),
                    this.position.includes("right") ? this.container.classList.add(t + "right") : this.container.classList.remove(t + "right"),
                    this.position.includes("top") ? this.container.classList.add(t + "top") : this.container.classList.remove(t + "top"),
                    this.position.includes("bottom") ? this.container.classList.add(t + "bottom") : this.container.classList.remove(t + "bottom");
            }),
            ...
            (o.prototype.setContent = function () {
                ...
                e.classList.add("notify__title"), (e.innerHTML = this.title), this.isCloseButton || (e.style.paddingRight = "0");
                var s = document.createElement("div");
                s.classList.add("notify__text"), (s.innerHTML = this.text), this.title || (s.style.marginTop = "0"), this.wrapper.appendChild(t), t.appendChild(e), t.appendChild(s);
            }),
